...
@router.post("", response_model=CourseOut, dependencies=[Depends(RoleChecker(["admin"]))])
...
@router.post("/modules", response_model=ModuleOut, dependencies=[Depends(RoleChecker(["admin", "teacher"]))])
...
@router.post("/lessons", response_model=LessonOut, dependencies=[Depends(RoleChecker(["admin", "teacher"]))])
